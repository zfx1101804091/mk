...
public class DateUtils {
    ...
    public static String dateToString(Date date, String pattern) {
        if (date == null) {
            ...
            return CommonUtils.format(date, pattern);
        }
    }
    ...
    public static Date stringToDate(String string, String pattern) {
        ...
        try {
            ...
            return CommonUtils.parse(string, pattern);
    ...
    //在年月日后面增加时分秒，开始时间：增加0点0分0秒     结束时间：增加23点59分59秒
    public static String getDateString(String dateString, String type) {
        String str = "";
        if (null == dateString || "".equals(dateString.trim())) {
            return str;
        } else {
            if (type.equals("begin")) {
                str = dateString + " 00:00:00";
                // HH:mm:ss
            }
            if (type.equals("end")) {
                str = dateString + " 23:59:59";
                // HH:mm:ss
            }
        }
        return str;
    ...
    public static String getBetweenTimes(Date start, Date end) {
        String currentDate = "";
        long start_day = start.getTime();
        long end_day = end.getTime();


        long l = start_day - end_day;  //当前时间-转交时间=待办时长
        long day = l / (24 * 60 * 60 * 1000);
        long hour = (l / (60 * 60 * 1000) - day * 24);
        long min = ((l / (60 * 1000)) - day * 24 * 60 - hour * 60);
        long s = (l / 1000 - day * 24 * 60 * 60 - hour * 60 * 60 - min * 60);
        currentDate = "" + day + "天" + hour + "小时" + min + "分" + s + "秒";
